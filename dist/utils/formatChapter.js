...
var formattedChapter = function (chapterNumber, page) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1["default"].get("https://api.quran.com/api/v4/verses/by_chapter/".concat(chapterNumber, "?words=true&word_fields=code_v2,v2_page,line_v2&page=").concat(page, "&per_page=50"))];
            case 1:
                res = _b.sent();
                return [3 /*break*/, 3];
            case 2:
            ...
            case 3:
                ...
                if (((_a = data === null || data === void 0 ? void 0 : data.verses) === null || _a === void 0 ? void 0 : _a.length) < 1) {
                    return [2 /*return*/, 404];
                }
...
exports["default"] = formattedChapter;
//# sourceMappingURL=formatChapter.js.map